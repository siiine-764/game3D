...
/*   Updated: 2023/12/09 07:44:47 by hben-mes         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/// functions draw ////
void						ft_draw_cub(mlx_image_t *map, int width, int height,
								int x_start, int y_start, int color);
// void ft_first_draw(t_map *map);
void						ft_draw(t_map *map);
void						ft_draw_wall(t_map *map, float ray_nb);
void						ft_first_draw(mlx_image_t *image);

t_vector					ft_util(t_map *map, float d_vertical,
								float d_horizontal, t_vector ray_vertic,
