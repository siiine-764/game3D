...
## Composition
Colors are commonly represented as `4-byte` integers. This 4-byte integer is a grouping of four individual channels: red, green, blue and alpha, with alpha representing transparency. Additionally, colors are usually shown in hexadecimal to make each channel val identifiable:
...
Combining these four channel vals into one will result in a non-transparent, white color.
...
int32_t	main(void)
{
    ...
    // Set the channels of each pixel in our image to the maximum byte val of 255. 
